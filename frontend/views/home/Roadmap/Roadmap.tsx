...
const Roadmap: NextPage = () => {
  return (
    <div className="contest-section" id="roadmap">
                ...
                >
                  <div className="contest-list">
                    <div className="single-contest">
                      <div className="row">
                        <div className="col-xl-7 col-lg-7 part-left"></div>
                        <div className="col-xl-5 col-lg-5 part-right">
                          <div className="contest-date-text">
                            <h4>
                              <span className="clndr-icon">
                                <svg
                                  ...
                                  viewBox="0 0 448 512"
                                  className="svg-inline--fa fa-calendar-alt fa-w-14 fa-fw fa-2x"
                                >
                                  <path
                                    fill="currentColor"
                      ...
                      <div className="row">
                        ...
                        <div className="col-xl-5 col-lg-5 part-right">
                          <div className="contest-date-text">
                            ...
                            <p>GamerHub Platform Launch</p>
                            <p>Public Sales</p>
                            <p>Staking and Liquidity Mining</p>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="col-xl-5 col-lg-5 part-right">
                          <div className="contest-date-text">
                            <h4>
                              ...
                              Thursday 03 September 2020 | 01:00 GMT
                            </h4>
                            <p>
                              Lorem ipsum dolor sit amet consectetur adipisicing
                              elit. Reprehenderit qui officiis doloremque quod
                              assumenda dolorem odio eveniet quo, minus natus,
                              fuga ad? Maxime voluptatem laboriosam cumque,
                              veniam fuga cupiditate voluptas!
                            </p>
                          </div>
                        </div>
                      </div>
